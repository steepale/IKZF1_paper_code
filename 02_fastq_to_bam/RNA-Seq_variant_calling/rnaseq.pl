...
foreach my $lane (@lanes){
	...
	my $cmd1="java -jar $trimm/trimmomatic-0.35.jar PE -threads 8 $fq_out_R1 $fq_out_R2 $tri_out_R1_pe $tri_out_R1_un $tri_out_R2_pe $tri_out_R2_un ILLUMINACLIP:$trimm/adapters/TruSeq3-PE.fa:2:30:10"; # Trim reads of adaptors and low quality bases
	print "$cmd1\n";
